...
import 'package:doctor_app/app/modules/patient/controllers/consult_c_controller.dart';
...
class ConsultPView extends GetView<ConsultController> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: appbar(ConsultViewtitles.consult, false),
          // centerTitle: false,
        ),
        body: Container(
          child: Column(
    ...
    return Obx(
      () => Expanded(
          child: ListView.builder(
              ...
              itemCount: controller.consult.length,
              itemBuilder: (BuildContext context, int index) {
                ConsultImage data = controller.consult[index];
                print(data.toString());
                return Card(
                  child: Container(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: CachedNetworkImage(
                                        imageUrl:
                                            '${controller.consultpath}/${data.doctorImage.toString()}',
                                      ),
                                      // width: 120,
                                    ),
                                    Text(
